    ...
    <div class="box-collapse-wrap form">
      <form class="form-a">
        <div class="row">
          ...
          <div class="col-md-6 mb-2">
            <div class="form-group">
              <label for="Type"> Budget Price </label>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="select-single.html">Selected Single</a>
              <a class="dropdown-item" href="Consumer-single.html">Profile</a>
              <a class="dropdown-item" href="User_Login.html">LogOut </a>
              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    ...
                    <a href="/PropertySingle" class="link-a">Click here to view
